...
struct  ArmatureType_t3944729913 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ArmatureType_t3944729913, ___value___1)); }
