...
extern "C"  void Vector3_Set_m2387909324 (Vector3_t4282066566 * __this, float ___new_x0, float ___new_y1, float ___new_z2, const MethodInfo* method)
{
	{
		float L_0 = ___new_x0;
		__this->set_x_1(L_0);
...
extern "C"  void Vector3_Set_m2387909324_AdjustorThunk (Il2CppObject * __this, float ___new_x0, float ___new_y1, float ___new_z2, const MethodInfo* method)
{
	Vector3_t4282066566 * _thisAdjusted = reinterpret_cast<Vector3_t4282066566 *>(__this + 1);
	Vector3_Set_m2387909324(_thisAdjusted, ___new_x0, ___new_y1, ___new_z2, method);
}
